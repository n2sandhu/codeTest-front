      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/employees/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Employee.manager() instead.
            "prototype$__get__manager": {
              url: urlBase + "/employees/:id/manager",
              method: "GET",
            },
        ...
        */
        R.modelName = "Employee";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Employee#manager
             * @methodOf lbServices.Employee
             *
             * @description
             *
        ...
        R.manager = function() {
          ...
          var action = TargetResource["::get::Employee::manager"];
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Manager#updateAttributes
             * @methodOf lbServices.Manager
             *
             * @description
             *
